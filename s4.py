...
class s4_class:
    def __init__(self,root):
        self.root = root
        self.root.title("Gastroenterology, Hepatology & Endoscopy")
...
##TITLE
        title = Label(self.root, text = "Gastroenterology, Hepatology & Endoscopy", font = ("goudy old style", 30, "bold",'underline'), bg = "#000064", fg = "white").place(x = 10, y = 15, width = 1270, height = 70)
...
##Variables
        ...
        lbl_txt = Label(self.root, text = info, font = ("goudy old style", 16, "bold"), bg = "white",justify=LEFT).place(x = 0, y = 200, width = 1270, height = 350)
